...
namespace tezcat.Framework.Test
{
    public class TeztCategory
    {
        public void generateCShapFile()
        {
             ...
             * Json text
             * 
             * use TezCategorySystem.generateCodeFile to generate a xx.cs file like this
             * 
             {
                "Namespace": "tezcat.Framework.Core",
                "WrapperClass": "MyCategory",
                "Root": {
                    "Equipment": {
                        "Armor": [
                            "ArmorPlate"
    ...
    public class MyFrigate
    {
        public TezCategory category = TezCategorySystem.getCategory(MyCategory.Ship.Frigate);
    }

    public class MyGun
    {
        public TezCategory category = TezCategorySystem.getCategory(MyCategory.Weapon.Gun);
    }

    public class TestCategory
    {
        MyFrigate myFrigate = new MyFrigate();
        ...
        public void test()
        {
            ...
            if (myFrigate.category == myGun.category)
            {
                //dosomething
            }
            else
            ...
            switch(myFrigate.category.finalToken.intValue)
            {
