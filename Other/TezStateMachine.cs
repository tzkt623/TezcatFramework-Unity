...
namespace tezcat.Framework.Utility
{
    ...
    {
        public int state;
        public TezEventExtension.Action<Camera, EventSystem> function;
    }

    public static class TezStateMachine
    {
        public static event TezEventExtension.Action<int> onPop;
        public static event TezEventExtension.Action<int> onPush;
        ...
        public static void register(int state, TezEventExtension.Action<Camera, EventSystem> function)
        {
