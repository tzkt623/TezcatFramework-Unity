...
{
    public static class TezAttributeElement
    {
        public class Element : ITezAttributeToken
        {
            public int tokenID { get; }
            public string tokenName { get; }
            public TezAttributeTokenType tokenType { get; }
        ...
        public static Element createSecondaryElement(string name)
        {
            ...
            var element = new Element(id, name, TezAttributeTokenType.Leaf);
