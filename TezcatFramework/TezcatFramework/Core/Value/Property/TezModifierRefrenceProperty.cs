...
namespace tezcat.Framework.Core
{
    public interface ITezModifierRefrenceProperty : ITezProperty
    {
        ...
        void createRefrence(TezAttributeDef definition, TezValueModifierConfig modifierConfig, object source);
    }
        ...
        , ITezModifierRefrenceProperty
    {
        ...
        public void createRefrence(TezAttributeDef definition, TezValueModifierConfig modifierConfig, object source)
        {
